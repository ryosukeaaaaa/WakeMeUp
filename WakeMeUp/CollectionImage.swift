...
struct CollectionImage: View {
    ...
    var body: some View {
        ZStack {
            ...
            // 他の画像を指定の座標に配置
            transformedImage(image: Image("Pteranodon"), size: CGSize(width: 530, height: 530), frameWidth: -41, frameHeight: -3, a: CGFloat(a), isBlack: !itemState.UserItems.contains("Pteranodon"))
            transformedImage(image: Image("Spinosaurus"), size: CGSize(width: 701, height: 701), frameWidth: 262, frameHeight: 97, a: CGFloat(a), isBlack: !itemState.UserItems.contains("Spinosaurus"))
            ...
            transformedImage(image: Image("Triceratops"), size: CGSize(width: 605, height: 605), frameWidth: 843, frameHeight: 107, a: CGFloat(a), isBlack: !itemState.UserItems.contains("Triceratops"))
            transformedImage(image: Image("Koala"), size: CGSize(width: 214, height: 214), frameWidth: 747, frameHeight: 486, a: CGFloat(a), isBlack: !itemState.UserItems.contains("Koala"))
            ...
            transformedImage(image: Image("Ostrich"), size: CGSize(width: 386, height: 386), frameWidth: 565, frameHeight: 465, a: CGFloat(a), isBlack: !itemState.UserItems.contains("Ostrich"))
            transformedImage(image: Image("Hippo"), size: CGSize(width: 499, height: 499), frameWidth: 1036, frameHeight: 504, a: CGFloat(a), isBlack: !itemState.UserItems.contains("Hippo"))
            transformedImage(image: Image("Bear"), size: CGSize(width: 367, height: 367), frameWidth: 849, frameHeight: 520, a: CGFloat(a), isBlack: !itemState.UserItems.contains("Bear"))
            transformedImage(image: Image("Panda"), size: CGSize(width: 338, height: 338), frameWidth: 745, frameHeight: 613, a: CGFloat(a), isBlack: !itemState.UserItems.contains("Panda"))
            ...
            transformedImage(image: Image("Sheep"), size: CGSize(width: 296, height: 296), frameWidth: 1456, frameHeight: 698, a: CGFloat(a), isBlack: !itemState.UserItems.contains("Sheep"))
            ...
            transformedImage(image: Image("Cheetah"), size: CGSize(width: 386, height: 386), frameWidth: 211, frameHeight: 575, a: CGFloat(a), isBlack: !itemState.UserItems.contains("Cheetah"))
            transformedImage(image: Image("Gorilla"), size: CGSize(width: 367, height: 367), frameWidth: 434, frameHeight: 589, a: CGFloat(a), isBlack: !itemState.UserItems.contains("Gorilla"))
            transformedImage(image: Image("Kangal"), size: CGSize(width: 366, height: 366), frameWidth: 519, frameHeight: 599, a: CGFloat(a), isBlack: !itemState.UserItems.contains("Kangal"))
            transformedImage(image: Image("Wolf"), size: CGSize(width: 318, height: 318), frameWidth: 686, frameHeight: 665, a: CGFloat(a), isBlack: !itemState.UserItems.contains("Wolf"))
